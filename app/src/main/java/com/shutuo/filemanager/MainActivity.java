package com.shutuo.filemanager;
...
import com.shutuo.filemanager.adapter.FileListAdapter;
import com.shutuo.filemanager.usbHelper.USBBroadCastReceiver;
import com.shutuo.filemanager.usbHelper.UsbHelper;
import com.shutuo.filemanager.util.ImageNameUtil;
import com.shutuo.filemanager.util.ImageUtils;
...
public class MainActivity extends AppCompatActivity implements View.OnClickListener   {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(com.shutuo.filemanagement.R.layout.file_activity_main);
        initViews();
        if (receiver==null){
    ...
    private void initViews() {
        ...
        u_disk_write = (Button) findViewById(com.shutuo.filemanagement.R.id.u_disk_write);
        u_disk_read = (Button) findViewById(com.shutuo.filemanagement.R.id.u_disk_read);
        u_disk_show = (TextView) findViewById(com.shutuo.filemanagement.R.id.u_disk_show);
        u_disk_listview = (ListView) findViewById(com.shutuo.filemanagement.R.id.u_disk_listview);
    ...
    protected void onStart() {
        ...
        u_disk_listview.setOnItemLongClickListener(new AdapterView.OnItemLongClickListener(){
            ...
            public boolean onItemLongClick(AdapterView<?> parent, View view, int position, long id) {
                String path = IMAGE_FILE_PATH+File.separator+imageList.get(position).getName();
                Log.d(TAG, "onItemLongClick: path = "+ path);
    ...
    public void onClick(View view) {
            if(view.getId() == com.shutuo.filemanagement.R.id.u_disk_write) {
                Intent intent = new Intent(MainActivity.this,com.shutuo.face.register.MainActivity.class);
                startActivity(intent);
                OK = false;
            }
            if (view.getId() == com.shutuo.filemanagement.R.id.u_disk_read){
    ...
    private void showCustomizeDialog(final String path, final int position) {
        final View dialogView; dialogView = LayoutInflater.from(MainActivity.this).inflate(com.shutuo.filemanagement.R.layout.dialog_customize,null);
        customizeDialog.setTitle("图片重命名");
        customizeDialog.setView(dialogView);
        final EditText edit_text = (EditText) dialogView.findViewById(com.shutuo.filemanagement.R.id.dialog_edit_text);
        Log.d(TAG, "showCustomizeDialog: ImageName = "+ImageNameUtil.getLastName(path));
        ...
        customizeDialog.setPositiveButton("确定",
                new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialog, int which) {
                        ...
                        String name = IMAGE_FILE_PATH+"/"+newName+".jpg";

                        isRunber(path,name,newName,position);
                        Toast.makeText(MainActivity.this,"已更改为: "+
                                edit_text.getText().toString()+".jpg",
    ...
    public void isRunber(final String oldName, final String newName, final String name, final int position){
            ...
            public void run() {
                ...
                try {
                    for (UsbFile usbFile : file){
                        //复制到本地的文件路径
                        String filePath = IMAGE_FILE_PATH + File.separator + ImageNameUtil.getLastName(usbFile.getName())+".jpg";
                        Log.d(TAG, "run: usbFile = "+filePath);
                        //开始写入
    ...
    protected void onDestroy() {
        ...
        LruCacheUtils.deleteFiles(IMAGE_LOAD_PATH);
    }
